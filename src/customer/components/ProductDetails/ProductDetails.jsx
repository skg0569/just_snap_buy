    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex items-center space-x-5 text-lg lg:text-xl text-gray-900 mt-6">
                ...
                <p className="text-red-500">5%Off</p>
              </div>
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="ml-3 font-medium text-indigo-600 hover:text-indigo-500">
                    3870 Reviews
                  </p>
                </div>
              </div>
        ...
        <section>
          ...
          <div className="border-2 border-gray-2000 p-5 rounded-lg">
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <p className="opacity-60">59650 Ratings</p>
                </div>
                <Box className="mt-4 space-y-2">
                  ...
                  <Grid container alignItems={"center"} gap={3}>
                    ...
                    <Grid item xs={7}>
                      <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4, height:7}} variant="determinate" value={30} className="bg-yellow-500"/>
                    </Grid>
                  </Grid>
        ...
        <section className="pt-10">
          <h1 className="font-semibold text-xl pb-4">Similar Products</h1>
